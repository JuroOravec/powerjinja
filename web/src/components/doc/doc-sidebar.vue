...
<div class="wrapper">
    <!-- Sidebar -->
    <nav id="sidebar" class="documentation-sidebar relative top-0 bottom-0 right-0 px2 py2" :class="active">
      <div class="doc-sidebar-wrap font-smaller fixed top-0 bottom-0 overflow-auto black bg-cloudy">
        <div class="px2 doc-sidebar">
        <div id="dismiss" v-on:click="onDismiss">
        </div>
         <doc-sidebar-module v-for="(apiModule, key) in docData" v-bind:key="key" :apiModule="apiModule" ></doc-sidebar-module>
    
        </div></div></nav>
    <button type="button" id="sidebarCollapse" class="btn btn-info" v-on:click="onToggle">
      <span>{{ arrow }}</span>
    </button>
    <!-- Dark Overlay element -->
    <div class="overlay" :class="active" v-on:click="onDismiss"></div>
</div>
</template>


<script>
import docSidebarModule from "./doc-sidebar-module.vue";
