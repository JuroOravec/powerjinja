...
export function containsOnlyItemsTimes(config: Powerjinja["config"]) {
  return `
{%- macro contains_only_items_times(arg1=None, arg2=None, arg3=None, arg4=None, arg5=None, macros=[], index=0) -%}
	{%- set all_match = [] -%}
	{%- set correct_match = [] -%}
	{%- for item in arg2 -%}
