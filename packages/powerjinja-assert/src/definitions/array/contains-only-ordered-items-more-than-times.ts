...
export function containsOnlyOrderedItemsMoreThanTimes(config: Powerjinja["config"]) {
  return `
{%- macro contains_only_ordered_items_more_than_times(arg1=None, arg2=None, arg3=None, arg4=None, arg5=None, macros=[], index=0) -%}
