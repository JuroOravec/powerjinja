...
export function containsOnlyItemsLessThanTimes(config: Powerjinja["config"]) {
  const append = config.command.append;
return `
{%- macro contains_only_items_less_than_times(arg1=None, arg2=None, arg3=None, arg4=None, arg5=None, macros=[], index=0) -%}
	{%- set all_match = [] -%}
	{%- set correct_match = [] -%}
	{%- for item in arg2 -%}
