...
powerjinjaArguments.define('powerjinja.arguments.move_fifth_left', moveFifthLeft);
powerjinjaArguments.define('powerjinja.arguments.move_fifth_right', moveFifthRight);
powerjinjaArguments.define('powerjinja.arguments.move_first_left', moveFirstLeft);
powerjinjaArguments.define('powerjinja.arguments.move_first_right', moveFirstRight);
powerjinjaArguments.define('powerjinja.arguments.move_fourth_left', moveFourthLeft);
powerjinjaArguments.define('powerjinja.arguments.move_fourth_right', moveFourthRight);
powerjinjaArguments.define('powerjinja.arguments.move_second_left', moveSecondLeft);
powerjinjaArguments.define('powerjinja.arguments.move_second_right', moveSecondRight);
powerjinjaArguments.define('powerjinja.arguments.move_third_left', moveThirdLeft);
powerjinjaArguments.define('powerjinja.arguments.move_third_right', moveThirdRight);
